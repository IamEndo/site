      ...
      <div className="max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <FlowStep 
              ...
              note="PayDeck detects the payment within seconds via its Rostrum server"
            />
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <StateCard 
              ...
              description="Transaction detected on the network (0-conf, before block confirmation)"
              color="green"
            />
          </div>
          ...
          <div className="mt-4 p-4 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800">
            <div className="flex gap-3">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-300">
                <strong>Instant detection:</strong> The Nexa network generates double-spend proofs
                when conflicting spends are detected. PayDeck relies on its Rostrum server's view
                of the network and does not verify these proofs itself. Instant detection is fine
                for everyday retail; for higher-value sales, wait for a confirmation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            <FeatureItem text="Transaction broadcast is detected within seconds via the Rostrum server" />
            <FeatureItem text="PayDeck verifies the payment matches the requested amount" />
            <FeatureItem text="The Nexa network generates double-spend proofs if conflicting spends appear" />
            <FeatureItem text="Suitable for everyday retail; wait for a confirmation on higher-value sales" />
          </div>
