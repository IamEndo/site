      ...
      <div className="max-w-4xl">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed">
            Everything you need to build your PayDeck device. The total cost is typically around $10,
          ...
          <div className="overflow-hidden rounded-lg border border-zinc-200 dark:border-zinc-800">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                ...
                <SpecRow label="Power Draw" value="~150 mA typical, ~200 mA peak" />
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <AccessoryCard 
              ...
              required={false}
              tip="The device draws ~150 mA typical, ~200 mA peak. Any phone charger will work."
            />
          </div>
        </section>
